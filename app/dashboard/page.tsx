        ...
        <div className="space-y-6">
            ...
            <div className="grid  gap-4 md:grid-cols-4">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-xl font-bold">{isLoading ? "...." : state?.totalRepos}</div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-xl font-bold">{isLoading ? "...." : state?.totalCommits || 0}</div>
                        <p className="text-muted-foreground text-xs">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-xl font-bold">{isLoading ? "...." : state?.totalPRs || 0}</div>
                        <p className="text-muted-foreground text-xs">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-xl font-bold">{isLoading ? "...." : state?.totalReviews || 0}</div>
                        <p className="text-muted-foreground text-xs">
